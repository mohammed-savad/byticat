            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form method="post" action="{{route('store_users')}}" enctype='multipart/form-data' class="form-horizontal">
                            @csrf
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="password" id="password" name="password" value="{{old('password')}}" placeholder="Enter Strong Password..." class="form-control">
